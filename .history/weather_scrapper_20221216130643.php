<?php
    ...
    if(array_key_exists('city', $_GET)) {
        ...
        if($file_headers[0] == "HTTP/1.1 404 Not Found") {
            ...
            $pageArray = 
               $forecastPage);               explode('Weather Today</h2> (1&ndash;3 days)</div><p class="b-forecast__table-description-content"><span class="phrase">',
...
<fieldset class="form-group">
                    ...
                    <input type="text" 
                           ...
                           name="city" 
                           id="city" 
                           placeholder="Eample... China, Israel"
                            value = 
                            "<?php 
                                if(array_key_exists('city', $_GET)) {
                                    echo $_GET['city'];
